 ...
 * License: MIT
 *
 * Generated at 2014-11-19 17:11:01 +0100
 */
(function() {
'use strict';
    ...
    return {
        ...
        controller: ["$scope","$attrs","$element", function($scope, $attrs, $element) {
            ...
            tagsInputConfig.load('tagsInput', $scope, $attrs, {
                ...
                disableRemovingTagProperty: [Boolean, 'disable'],
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            scope.isTagDisabled = function(tag) {
                return tag[options.disableRemovingTagProperty] === true;
            };
...
tagsInput.run(["$templateCache", function($templateCache) {
    ...
    "<div class=\"host\" tabindex=\"-1\" ti-transclude-append=\"\"><div class=\"tags form-control\" ng-class=\"{focused: hasFocus}\"><ul class=\"tag-list\"><li class=\"tag-item\" ng-repeat=\"tag in tagList.items track by track(tag)\" ng-class=\"{ selected: tag == tagList.selected, 'disable': isTagDisabled(tag)}\"><span ng-bind=\"getDisplayText(tag)\"></span> <a class=\"remove-button\" ng-if=\"!isTagDisabled(tag)\" ng-click=\"tagList.remove($index)\" ng-bind=\"options.removeTagSymbol\"></a></li></ul><input class=\"input\" ng-model=\"newTag.text\" ng-change=\"newTagChange()\" ng-trim=\"false\" ng-class=\"{'invalid-tag': newTag.invalid}\" ti-bind-attrs=\"{type: options.type, placeholder: options.placeholder, tabindex: options.tabindex}\" ti-autosize=\"\"></div></div>"
  );

  $templateCache.put('ngTagsInput/auto-complete.html',
    "<div class=\"autocomplete\" ng-show=\"suggestionList.visible\"><ul class=\"suggestion-list dropdown-menu\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by track(item)\" ng-class=\"{selected: item == suggestionList.selected}\" ng-click=\"addSuggestionByIndex($index)\" ng-mouseenter=\"suggestionList.select($index)\" ng-bind-html=\"highlight(item)\"></li></ul></div>"
  );
}]);
